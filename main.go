...
var (
	...
	modelNames = flag.String("model-names",
		"",
		"specify the comma-separated list of model name; must be set")
	modelPkgPath = flag.String("model-pkg-path",
		"",
		"specify the package path corresponding to the model directory; automatically calculated by default")
	modelPkgAlias = flag.String("model-pkg-alias",
		"",
		"specify a model package alias; default no alias")
	mysqlPkgPath = flag.String("mysql-pkg-path",
		"",
		"set auto create table or not")
	daoDir = flag.String("dao-dir",
		"",
		"specify the output directory of dao files; must be set")
	daoPkgPath = flag.String("dao-pkg-path",
		"",
		"specify the package path corresponding to the output directory of the dao files; automatically generated by default")
	subPkgEnable = flag.Bool("sub-pkg-enable",
		false,
		"specify whether to enable sub-pkg; default disable")
	subPkgStyle = flag.String("sub-pkg-style",
		"kebab",
		"specify the generation style for sub-pkg; options: kebab | underscore | lower | camel | pascal; default is kebab")
	fileNameStyle = flag.String("file-style",
		"underscore",
		"specify the generation style for file; options: kebab | underscore | lower | camel | pascal; default is underscore")
	instanceFunc = flag.String("instance-func",
		"Instance",
		"specifies the function name for creating a database connection instance; options:Instance | InstanceWrite | InstanceRead; default is Instance")
)
...
func main() {
	log.SetFlags(0)
	log.SetPrefix("xgorm-dao-generator: ")
	flag.Usage = usage
	flag.Parse()
	...
	newGenerator(&options{
		...
		daoMysqlImpPkgPath: *mysqlPkgPath,
	}).makeDao()
}
