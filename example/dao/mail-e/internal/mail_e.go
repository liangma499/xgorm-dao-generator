...
func NewMailE(db *gorm.DB) *MailE {
	dao := &MailE{}
	dao.Columns = mailEColumns
	dao.TableName = "mail_e"
	dao.Database = db
	dao.Table = db.Model(&modelpkg.MailE{}).Table(dao.TableName)

	return dao
}

// New create a new instance and return
func (dao *MailE) New(tx *gorm.DB) *MailE {
	d := &MailE{}
	d.Columns = dao.Columns
	d.TableName = dao.TableName
	d.Database = tx
	d.Table = tx.Model(&modelpkg.MailE{}).Table(d.TableName)

	return d
}

// Insert executes an insert command to insert multiple documents into the collection.
func (dao *MailE) Insert(ctx context.Context, models ...*modelpkg.MailE) (int64, error) {
	if len(models) == 0 {
...
func (dao *MailE) Delete(ctx context.Context, filterFunc ...FilterFunc) (int64, error) {
	...
	rst := db.Delete(&modelpkg.MailE{})

	return rst.RowsAffected, rst.Error
}

// Update executes an update command to update documents in the collection.
func (dao *MailE) Update(ctx context.Context, filterFunc FilterFunc, updateFunc UpdateFunc) (int64, error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *MailE) Count(ctx context.Context, filterFunc ...FilterFunc) (count int64, err error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *MailE) Sum(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (sums []float64, err error) {
...
func (dao *MailE) Avg(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (avgs []float64, err error) {
	columns := columnFunc(dao.Columns)
	if len(columns) == 0 {
		return
	}
...
func (dao *MailE) First(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.MailE, error) {
	var (
		model = &modelpkg.MailE{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *MailE) Last(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.MailE, error) {
	var (
		model = &modelpkg.MailE{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *MailE) FindOne(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.MailE, error) {
	var (
		model = &modelpkg.MailE{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *MailE) FindMany(ctx context.Context, filterFunc FilterFunc, columnFunc ColumnFunc, orderFunc OrderFunc, limitAndOffset ...int) ([]*modelpkg.MailE, error) {
	var (
		models = make([]*modelpkg.MailE, 0)
		db     = dao.Table.WithContext(ctx)
	)
