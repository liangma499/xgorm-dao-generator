...
func NewMail(db *gorm.DB) *Mail {
	...
	dao.TableName = "mail"
	dao.Database = db
	dao.Table = db.Model(&modelpkg.Mail{}).Table(dao.TableName)
...
func (dao *Mail) New(tx *gorm.DB) *Mail {
	...
	d.Database = tx
	d.Table = tx.Model(&modelpkg.Mail{}).Table(d.TableName)
...
func (dao *Mail) Delete(ctx context.Context, filterFunc ...FilterFunc) (int64, error) {
...
func (dao *Mail) Update(ctx context.Context, filterFunc FilterFunc, updateFunc UpdateFunc) (int64, error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *Mail) Count(ctx context.Context, filterFunc ...FilterFunc) (count int64, err error) {
	db := dao.Table.WithContext(ctx)
...
func (dao *Mail) Sum(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (sums []float64, err error) {
...
func (dao *Mail) Avg(ctx context.Context, columnFunc ColumnFunc, filterFunc ...FilterFunc) (avgs []float64, err error) {
	columns := columnFunc(dao.Columns)
	if len(columns) == 0 {
		return
	}
...
func (dao *Mail) First(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.Mail, error) {
	var (
		model = &modelpkg.Mail{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *Mail) Last(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.Mail, error) {
	var (
		model = &modelpkg.Mail{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *Mail) FindOne(ctx context.Context, filterFunc FilterFunc, columnFunc ...ColumnFunc) (*modelpkg.Mail, error) {
	var (
		model = &modelpkg.Mail{}
		db    = dao.Table.WithContext(ctx)
	)
...
func (dao *Mail) FindMany(ctx context.Context, filterFunc FilterFunc, columnFunc ColumnFunc, orderFunc OrderFunc, limitAndOffset ...int) ([]*modelpkg.Mail, error) {
	var (
